    ...
    <>
      ...
      <div className="milestones">
        ...
        <div className="mile-contents">
          Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc
          vulputate libero et velit interdum ,ac aliquet <br /> odio mattis
      ...
      <div className="showcase">
        ...
        <div className="video">
        <iframe width="720" height="360" src="https://www.youtube.com/embed/h7MYJghRWt0" frameborder="0" allowfullscreen></iframe>
        ...
        <div className="contact">
          ...
          <div className="contact-buttons">
            ...
            <button className="contact-btn">
              <div className="hachu"> <span> <img src={email} alt="email" className="puku" /> </span>
              Send us an email </div>
              </button>

            <button className="contact-btn">
            <div className="hachu"><span> <img src={coffee} alt="coffee" className="puku" /> </span>
              Buy us a coffee </div></button>
